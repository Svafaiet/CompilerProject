...
compressed_grammar = [
    ...
    ["declaration", ["type-specifier", s("DECLARE_TYPE"), Token(CTokenType.ID), s("DECLARE_NAME"), "var-func-declaration"]],
    ...
    ["params", [ck("void"), s("ADD_PARAM")], [ck("void"), s("ADD_PARAM"), "param-left", "param-list"], [ck("int"), s("ADD_PARAM"), "param-left", "param-list"]],
