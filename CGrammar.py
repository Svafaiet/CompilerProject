...
compressed_grammar = [
    ...
    ["param-left", [Token(CTokenType.ID), s("DECLARE_NAME"), cs("["), s("DECLARE_VAR_SIZE"), cs("]")], [Token(CTokenType.ID), s("DECLARE_NAME")]],
    ...
    ["return-stmt", [ck("return"), cs(";")], [ck("return"), s("BEGIN_EXPRESSION_CHECK"), "expression",
                                              s("END_EXPRESSION_CHECK"), cs(";")]],
    ...
    ["call", [s("CHECK_EXPRESSION_FUNC"), s("CHECK_FUNC_ARGS_BEGIN"), cs("("), "args", s("CHECK_FUNC_ARGS_END"), cs(")")]],
    ["args",
     ["arg-list"],
     epsilon,
     ],
